...
COPY --chown=user:user sentiment_analysis /app/sentiment_analysis
...
RUN python -c 'from sentiment_analysis.config import Config; from taranis_base_bot.misc import get_model; get_model(Config)'
